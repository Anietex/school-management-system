...
/***/ "./resources/js/apps/admin/teachers/teachers.js":
/*!******************************************************!*\
  !*** ./resources/js/apps/admin/teachers/teachers.js ***!
  \******************************************************/
/*! no exports provided */
...
/* harmony import */ var _lib_Toast__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../lib/Toast */ "./resources/js/lib/Toast.js");
...
var $ = window.jQuery;
var http = new axios__WEBPACK_IMPORTED_MODULE_1___default.a.create({
...
var vm = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  methods: {
    ...
    addTeacher: function addTeacher(event) {
      var _this = this;

      this.addingTeacher = true;
      this.clearErrors();
      var data = new FormData(event.target);
      http.post('teachers', data).then(function (res) {
        _this.teachers.unshift(res.data);

        _this.resetFormFields();

        $('#teachers-modal').modal('hide');
        _lib_Toast__WEBPACK_IMPORTED_MODULE_2__["default"].success("Teacher was successfully added");
      }, function (err) {
        if (err.response.status === 422) {
          var errors = err.response.data.errors;
          Object.keys(errors).forEach(function (error) {
            _this.errors[error].show = true;
            _this.errors[error].message = errors[error][0];
          });
        } else {
          _lib_Toast__WEBPACK_IMPORTED_MODULE_2__["default"].error("Something went wrong please try again");
        }
      }).finally(function (res) {
        _this.addingTeacher = false;
      });
    },
    getTeachers: function getTeachers() {
      var _this2 = this;

      http.get("teachers").then(function (res) {
        var _this2$teachers;

        (_this2$teachers = _this2.teachers).push.apply(_this2$teachers, _toConsumableArray(res.data));
      });
    },
    ...
    updateTeacher: function updateTeacher(event) {
      ...
      http.post('teachers/' + this.teacher.id, data).then(function (res) {
    ...
    editTeacher: function editTeacher(teacher, index) {
      ...
      this.teacher = _objectSpread({}, teacher);
    ...
    updatePassword: function updatePassword(event) {
      ...
      if (this.newPassword.value === '') {
        ...
        http.post("teachers/change_password/" + this.currentId, {
          password: this.newPassword.value
        }).then(function (res) {
          _lib_Toast__WEBPACK_IMPORTED_MODULE_2__["default"].success("Password Updated successfully");
        }, function (err) {
...
/***/ 0:
/*!************************************************************!*\
  !*** multi ./resources/js/apps/admin/teachers/teachers.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/school-management/resources/js/apps/admin/teachers/teachers.js */"./resources/js/apps/admin/teachers/teachers.js");
