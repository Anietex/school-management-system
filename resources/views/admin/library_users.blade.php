...
@section('title','Library Users')

@section('action-button')
    <button type="button"  data-toggle="modal" data-target="#teachers-modal" class="btn btn-primary">New User</button>
@endsection
            ...
            <div class="modal-content ">
                <form>
                    <div class="modal-header">
                        <h5 class="modal-title" id="teachers-modal-label">Add User</h5>
